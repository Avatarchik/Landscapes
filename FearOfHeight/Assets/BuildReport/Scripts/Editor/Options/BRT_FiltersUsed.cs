...
public class FiltersUsed
{
	...
	static void SaveFileFilterGroupToFile(string saveFilePath, FileFilterGroup filterGroup)
	{
		...
		Debug.Log("Build Result Tool: Saved File Filter Group at \"" + saveFilePath + "\"");
	}
	...
	public static string GetProperFileFilterGroupToUseFilePath(string userFileFilterSavePath)
	{
		...
		// attempt to get from default Build Result Tool folder: Assets/BuildReport/Config/FileFiltersUsed.xml
		...
		// search for Build Result Tool folder in all subfolders of Assets folder and look for file there
...
*/
		...
		{
			Debug.Log("Created a new Build Result File Filter Config XML File at " + userFileFilterSavePath);
	...
	public static FileFilterGroup GetProperFileFilterGroupToUse(string userFileFilterSavePath)
	{
		...
		Debug.LogError("Build Result Tool: Could not find proper File Filter Group to use.");
		return null;
	}
}
