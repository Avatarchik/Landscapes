	...
	public override void DrawGUI(Rect position, BuildInfo buildReportToDisplay)
	{
		...
		GUILayout.BeginHorizontal();
			...
			GUILayout.BeginVertical();
				...
				GUILayout.BeginHorizontal();
					GUILayout.Label("Automatically show Build Result Window after building: ");
				...
				GUILayout.Label("Build Result Files", BuildReportTool.Window.Settings.INFO_TITLE_STYLE_NAME);
