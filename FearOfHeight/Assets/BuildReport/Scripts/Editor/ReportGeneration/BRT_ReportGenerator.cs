...
*/
	...
	const string NO_BUILD_INFO_WARNING = "Build Result Tool: No build info found. Build the project first. If you have more than one instance of the Unity Editor open, close all of them and open only one.";
	...
	[MenuItem("Window/Show Build Result")]
	...
	static void ShowBuildReportWithLastValues()
	{
		...
		//BRT_BuildReportWindow brtWindow = EditorWindow.GetWindow<BRT_BuildReportWindow>("Build Result", true, typeof(SceneView));
		BRT_BuildReportWindow brtWindow = (BRT_BuildReportWindow)EditorWindow.GetWindow(typeof(BRT_BuildReportWindow), false, "Build Result", true);
		//BRT_BuildReportWindow brtWindow = EditorWindow.GetWindow(typeof(BRT_BuildReportWindow), false, "Build Result", true) as BRT_BuildReportWindow;
