...
[CustomEditor(typeof(FOHUILevelTweeningButton))]
[CanEditMultipleObjects]
public class EditorFOHUILevelTweeningButton : Editor
{
    private FOHUILevelTweeningButton button;
    ...
    private void Awake()
    {
        button = target as FOHUILevelTweeningButton;
