...
[CustomEditor(typeof(FOHUIHighlightButton))]
[CanEditMultipleObjects]
public class EditorFOHUIHighlightButton : Editor
{
    private FOHUIHighlightButton button;
    ...
    private void Awake()
    {
        button = target as FOHUIHighlightButton;
