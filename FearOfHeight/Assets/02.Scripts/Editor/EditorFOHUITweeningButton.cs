...
[CustomEditor(typeof(FOHUITweeningButton))]
[CanEditMultipleObjects]
public class EditorFOHUITweeningButton : Editor
{
    private FOHUITweeningButton button;
    ...
    private void Awake()
    {
        button = target as FOHUITweeningButton;
