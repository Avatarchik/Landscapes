...
namespace DigitalOpus.MB.Core{
	public class MB3_TextureBakerEditorInternal{
        ...
        private static GUIContent
            createPrefabAndMaterialLabelContent = new GUIContent("Create Empty Assets For Combined Material", "Creates a material asset and a 'MB2_TextureBakeResult' asset. You should set the shader on the material. Mesh Baker uses the Texture properties on the material to decide what atlases need to be created. The MB2_TextureBakeResult asset should be used in the 'Material Bake Evaluation' field."),
			...
			textureBakeResultsGUIContent = new GUIContent("Material Bake Evaluation","This asset contains a mapping of materials to UV rectangles in the atlases. It is needed to create combined meshes or adjust meshes so they can use the combined material(s). Create it using 'Create Empty Assets For Combined Material'. Drag it to the 'Material Bake Evaluation' field to use it."),
		...
		public static void ConfigureMutiMaterialsFromObjsToCombine(MB3_TextureBaker mom, SerializedProperty resultMaterials, SerializedObject textureBaker){
			...
			if (mom.textureBakeResults == null){
				Debug.LogError("Material Bake Evaluation asset must be set before using this operation.");
				return;
			}
