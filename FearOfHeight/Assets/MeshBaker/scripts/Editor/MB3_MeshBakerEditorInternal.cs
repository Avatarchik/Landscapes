...
namespace DigitalOpus.MB.Core{
	...
	public class MB3_MeshBakerEditorInternal{
        ...
        private static GUIContent
			...
			textureBakeResultsGUIContent = new GUIContent("Material Bake Evaluation","When materials are combined a MB2_TextureBakeResult Asset is generated. Drag that Asset to this field to use the combined material."),
